  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (signedInUser?.must_change_password) {
        toast.info('Please choose a new password to continue.');
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-background">
        ...
        <Card className="w-full max-w-md border-border shadow-lg bg-card">
          <CardHeader className="text-center space-y-2 pb-2">
            ...
            <CardDescription className="text-muted-foreground">Sign in to access your audits</CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
            ...
            <div className="mt-5 rounded-md bg-muted/50 p-3 text-center text-xs text-muted-foreground">
              New accounts are created by your Infinit Audit administrator and temporary sign-in details are sent by email.
            </div>
